...
import com.angkorteam.pluggable.framework.panel.widget.WidgetDateField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetDateTimeField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetDropDownChoice;
import com.angkorteam.pluggable.framework.panel.widget.WidgetFileUploadField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetImageField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetLabelField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetListMultipleChoice;
import com.angkorteam.pluggable.framework.panel.widget.WidgetMultiFileUploadField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetPasswordTextField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetRadioChoice;
import com.angkorteam.pluggable.framework.panel.widget.WidgetSelect2Choice;
import com.angkorteam.pluggable.framework.panel.widget.WidgetSelect2MultiChoice;
import com.angkorteam.pluggable.framework.panel.widget.WidgetTextArea;
import com.angkorteam.pluggable.framework.panel.widget.WidgetTextField;
import com.angkorteam.pluggable.framework.panel.widget.WidgetTimeField;
import com.angkorteam.pluggable.framework.utilities.SelectionUtilities;
import com.angkorteam.pluggable.framework.utilities.TableUtilities;
import com.angkorteam.pluggable.framework.validation.constraints.DecimalMax;
import com.angkorteam.pluggable.framework.validation.constraints.DecimalMin;
import com.angkorteam.pluggable.framework.validation.constraints.Digits;
import com.angkorteam.pluggable.framework.validation.constraints.Future;
import com.angkorteam.pluggable.framework.validation.constraints.Max;
import com.angkorteam.pluggable.framework.validation.constraints.Min;
import com.angkorteam.pluggable.framework.validation.constraints.NotNull;
import com.angkorteam.pluggable.framework.validation.constraints.Past;
import com.angkorteam.pluggable.framework.validation.constraints.Pattern;
import com.angkorteam.pluggable.framework.validation.constraints.Size;
import com.angkorteam.pluggable.framework.validation.constraints.Unique;
import com.angkorteam.pluggable.framework.validation.controller.ButtonController;
import com.angkorteam.pluggable.framework.validation.controller.ChoiceController;
...
import com.angkorteam.pluggable.framework.wicket.markup.html.image.Image;
import com.angkorteam.pluggable.framework.widget.CheckBox;
import com.angkorteam.pluggable.framework.widget.CheckBoxMultipleChoice;
import com.angkorteam.pluggable.framework.widget.DropDownChoice;
import com.angkorteam.pluggable.framework.widget.FileUploadField;
import com.angkorteam.pluggable.framework.widget.ImageField;
import com.angkorteam.pluggable.framework.widget.LabelField;
import com.angkorteam.pluggable.framework.widget.ListMultipleChoice;
import com.angkorteam.pluggable.framework.widget.MultiFileUploadField;
import com.angkorteam.pluggable.framework.widget.RadioChoice;
import com.angkorteam.pluggable.framework.widget.Select2Choice;
import com.angkorteam.pluggable.framework.widget.Select2MultiChoice;
...
public abstract class KnownPage extends WebPage {
    ...
    private void initializeInterceptor() {
        ...
        for (Method method : ReflectionUtils.getAllMethods(this.getClass())) {
            if (method
                    .getAnnotation(com.angkorteam.pluggable.framework.widget.Button.class) != null) {
                com.angkorteam.pluggable.framework.widget.Button widget = method
                        .getAnnotation(com.angkorteam.pluggable.framework.widget.Button.class);
        ...
        ListView<ButtonController> commandListView = new ListView<ButtonController>(
            ...
            protected void populateItem(ListItem<ButtonController> item) {
                ...
                item.add(button);
                if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.DEFAULT) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-default"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.PRIMARY) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-primary"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.SUCCESS) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-success"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.INFO) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-info"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.WARNING) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-warning"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.DANGER) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-danger"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.framework.validation.type.ButtonType.LINK) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-link"));
                }
