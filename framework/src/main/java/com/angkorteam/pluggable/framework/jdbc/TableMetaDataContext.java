package com.angkorteam.pluggable.framework.jdbc;
...
public class TableMetaDataContext {
	...
	public String getSimulationQueryForGetGeneratedKey(String tableName,
		...
		return this.metaDataProvider.getSimpleQueryForGetGeneratedKey(
	...
	public int[] createColumnTypes(List<String> columns) {
		...
		List<TableParameterMetaData> parameters = this.metaDataProvider
				.getTableParameterMetaData();
