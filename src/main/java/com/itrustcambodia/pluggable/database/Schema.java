...
public abstract class Schema {
    ...
    public boolean exists() {
        try {
            ...
            throw new DatabaseException("Unable to check whether schema " + this + " exists", e);
        }
    }
    ...
    public boolean empty() {
        try {
            ...
            throw new DatabaseException("Unable to check whether schema " + this + " is empty", e);
        }
    }
    ...
    public void create() {
        try {
            ...
            throw new DatabaseException("Unable to create schema " + this, e);
        }
    }

    public abstract void createTable(Class<?> entity);

    public abstract void createTable(Class<?> entity, String... fields);

    public abstract void createTable(Class<?> entity, List<String> fields);

    public abstract void addColumn(Class<?> entity, String name);
    ...
    public void drop() {
        try {
            ...
            throw new DatabaseException("Unable to drop schema " + this, e);
        }
    }
    ...
    public void clean() {
        try {
            ...
            throw new DatabaseException("Unable to clean schema " + this, e);
        }
    }
    ...
    public Table[] allTables() {
        try {
            ...
            throw new DatabaseException("Unable to retrieve all tables in schema " + this, e);
        }
    }
    ...
    public final Function[] allFunctions() {
        try {
            ...
            throw new DatabaseException("Unable to retrieve all functions in schema " + this, e);
        }
    }
