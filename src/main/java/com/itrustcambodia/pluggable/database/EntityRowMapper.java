...
public class EntityRowMapper<T> implements RowMapper<T> {
    ...
    public EntityRowMapper(Class<T> clazz) {
        this.clazz = clazz;
        if (org.springframework.core.annotation.AnnotationUtils.findAnnotation(this.clazz, Entity.class) == null) {
            throw new DatabaseException(clazz.getSimpleName() + " is not entity");
        }
        ...
        if (entity != null) {
            for (int i = 1; i <= metaData.getColumnCount(); i++) {
                ...
                if (metaData.getColumnType(i) == Types.ARRAY) {
                    ...
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "BIGINT");
                } else if (metaData.getColumnType(i) == Types.BINARY) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "BINARY");
                    ...
                    if (field.getType().getName().equals("boolean") || field.getType().getName().equals("java.lang.Boolean")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "BIT");
                    }
                } else if (metaData.getColumnType(i) == Types.BLOB) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "BLOB");
                } else if (metaData.getColumnType(i) == Types.BOOLEAN) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "BOOLEAN");
                } else if (metaData.getColumnType(i) == Types.CHAR) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "CHAR");
                } else if (metaData.getColumnType(i) == Types.CLOB) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "CLOB");
                    ...
                    if (field.getType().getName().equals("double") || field.getType().getName().equals("java.lang.Double")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "DECIMAL");
                    }
                } else if (metaData.getColumnType(i) == Types.DISTINCT) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "DISTINCT");
                } else if (metaData.getColumnType(i) == Types.DOUBLE) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "DOUBLE");
                } else if (metaData.getColumnType(i) == Types.FLOAT) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "FLOAT");
                    ...
                    if (field.getType().getName().equals("java.lang.Long") || field.getType().getName().equals("long")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "INTEGER");
                    }
                } else if (metaData.getColumnType(i) == Types.JAVA_OBJECT) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "JAVA_OBJECT");
                } else if (metaData.getColumnType(i) == Types.LONGNVARCHAR) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "LONGNVARCHAR");
                } else if (metaData.getColumnType(i) == Types.LONGVARBINARY) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "LONGVARBINARY");
                    ...
                    if (field.getType().getName().equals("java.lang.String")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "LONGVARCHAR");
                    }
                } else if (metaData.getColumnType(i) == Types.NCHAR) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "NCHAR");
                } else if (metaData.getColumnType(i) == Types.NCLOB) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "NCLOB");
                } else if (metaData.getColumnType(i) == Types.NULL) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "NULL");
                } else if (metaData.getColumnType(i) == Types.NUMERIC) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "NUMERIC");
                } else if (metaData.getColumnType(i) == Types.NVARCHAR) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "NVARCHAR");
                } else if (metaData.getColumnType(i) == Types.OTHER) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "OTHER");
                } else if (metaData.getColumnType(i) == Types.REAL) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "REAL");
                } else if (metaData.getColumnType(i) == Types.REF) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "REF");
                } else if (metaData.getColumnType(i) == Types.ROWID) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "ROWID");
                } else if (metaData.getColumnType(i) == Types.SMALLINT) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "SMALLINT");
                } else if (metaData.getColumnType(i) == Types.SQLXML) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "SQLXML");
                    ...
                    if (field.getType().getName().equals("java.util.Date")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "TIMESTAMP");
                    }
                } else if (metaData.getColumnType(i) == Types.TINYINT) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "TINYINT");
                } else if (metaData.getColumnType(i) == Types.VARBINARY) {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "VARBINARY");
                    ...
                    if (field.getType().getName().equals("java.lang.String")) {
                        ...
                        throw new DatabaseException("DB Error " + field.getType().getName() + " " + "VARCHAR");
                    }
                } else {
                    throw new DatabaseException("DB Error " + field.getType().getName() + " " + "UNKNOW");
                }
            }
        }
        return entity;
