...
public class UrlFieldPanel extends Panel {
    ...
    public UrlFieldPanel(String id, FormItem<String> formItem) {
        super(id);
        add(new Label("label", formItem.getLabel()));

        UrlTextField userInput = new UrlTextField("userInput", new PropertyModel<String>(formItem, "userInput"));
