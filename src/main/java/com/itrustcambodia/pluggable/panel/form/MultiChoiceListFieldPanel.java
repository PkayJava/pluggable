...
public class MultiChoiceListFieldPanel<T> extends Panel {
    ...
    public MultiChoiceListFieldPanel(String id, FormItem<T> formItem) {
        super(id);
        add(new Label("label", formItem.getLabel()));

        ListMultipleChoice<T> userInput = new ListMultipleChoice<T>("userInput", new PropertyModel<Collection<T>>(formItem, "userInput"), formItem.getList());
