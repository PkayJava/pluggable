...
public class TextFieldPanel extends Panel {
    ...
    public TextFieldPanel(String id, FormItem<String> formItem) {
        super(id);
        add(new Label("label", formItem.getLabel()));

        TextField<String> userInput = new TextField<String>("userInput", new PropertyModel<String>(formItem, "userInput"));
