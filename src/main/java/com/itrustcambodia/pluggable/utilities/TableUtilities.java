...
import com.itrustcambodia.pluggable.database.DatabaseException;
...
public class TableUtilities {
    ...
    public static final String getTableName(Class<?> clazz) {
        ...
        com.itrustcambodia.pluggable.database.annotation.Table table = org.springframework.core.annotation.AnnotationUtils.findAnnotation(clazz, com.itrustcambodia.pluggable.database.annotation.Table.class);
