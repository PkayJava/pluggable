...
//import com.itrustcambodia.pluggable.core.ApplicationContextSupport;
...
//
//@Controller
//public class ResourceController extends ApplicationContextSupport {
//
...
//    public void file(@PathVariable("filename") String filename, HttpServletRequest request, HttpServletResponse response) throws IOException {
//        IApplication application = getApplicationContext().getBean(IApplication.class);
//        String type = request.getParameter("type");
//        if (type == null || type.equals("")) {
//            type = application.select(PluggableConstants.REPOSITORY, String.class);
//        } else {
//            if (!type.equals(PluggableConstants.REPOSITORY_AMAZON_S3) || !type.equals(PluggableConstants.REPOSITORY_LOCAL)) {
//                type = application.select(PluggableConstants.REPOSITORY, String.class);
//            }
//        }
//
...
//                String repository = application.select(PluggableConstants.LOCAL, String.class);
...
//    }
//
//    @ApiMethod(description = "image download", requestParameters = { @ApiParam(name = "ratio", description = "keep ratio", type = Boolean.class), @ApiParam(name = "type", type = String.class, allowedvalues = { PluggableConstants.REPOSITORY_LOCAL, PluggableConstants.REPOSITORY_AMAZON_S3 }) }, responseObject = byte[].class)
//    @RequestMapping(value = IMAGE + "/{filename:.*}", method = RequestMethod.GET)
//    public void image(@PathVariable("filename") String filename, HttpServletRequest request, HttpServletResponse response) throws IOException {
//        IApplication application = getApplicationContext().getBean(IApplication.class);
//        String type = request.getParameter("type");
//        if (type == null || type.equals("")) {
//            type = application.select(PluggableConstants.REPOSITORY, String.class);
...
//
//        boolean ratio = true;
//        if (request.getParameter("ratio") != null && request.getParameter("ratio") != null) {
...
//    }
//
//    private void stream(File file, HttpServletRequest request, HttpServletResponse response) throws IOException {
