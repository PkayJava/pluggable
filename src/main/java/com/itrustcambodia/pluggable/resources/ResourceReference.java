...
public class ResourceReference {
    ...
    public static final CssResourceReference BOOTSTRAP_CSS = new CssResourceReference(ResourceReference.class, "bootstrap/3.0.0/css/bootstrap.min.css");

    public static final CssResourceReference BOOTSTRAP_THEME_CSS = new CssResourceReference(ResourceReference.class, "bootstrap/3.0.0/css/bootstrap-theme.min.css");

    public static final JavaScriptResourceReference BOOTSTRAP_JS = new JavaScriptResourceReference(ResourceReference.class, "bootstrap/3.0.0/js/bootstrap.min.js");
