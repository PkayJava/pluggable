...
import com.angkorteam.pluggable.database.DbSupport;
import com.angkorteam.pluggable.database.DbSupportFactory;
import com.angkorteam.pluggable.database.EntityRowMapper;
import com.angkorteam.pluggable.database.Schema;
import com.angkorteam.pluggable.entity.AbstractUser;
import com.angkorteam.pluggable.entity.ApplicationRegistry;
import com.angkorteam.pluggable.entity.Group;
import com.angkorteam.pluggable.entity.Role;
import com.angkorteam.pluggable.migration.AbstractApplicationMigrator;
import com.angkorteam.pluggable.migration.AbstractPluginMigrator;
import com.angkorteam.pluggable.migration.ApplicationMigrator;
import com.angkorteam.pluggable.page.ApplicationSettingPage;
import com.angkorteam.pluggable.page.DashboardPage;
import com.angkorteam.pluggable.page.EditGroupPage;
import com.angkorteam.pluggable.page.EditUserPage;
import com.angkorteam.pluggable.page.GroupManagementPage;
import com.angkorteam.pluggable.page.HomePage;
import com.angkorteam.pluggable.page.LoginPage;
import com.angkorteam.pluggable.page.NewGroupPage;
import com.angkorteam.pluggable.page.NewUserPage;
import com.angkorteam.pluggable.page.SettingPage;
import com.angkorteam.pluggable.page.UserManagementPage;
import com.angkorteam.pluggable.page.WebPage;
import com.angkorteam.pluggable.quartz.Job;
import com.angkorteam.pluggable.quartz.Scheduled;
import com.angkorteam.pluggable.utilities.FrameworkUtilities;
import com.angkorteam.pluggable.utilities.GroupUtilities;
import com.angkorteam.pluggable.utilities.JobUtilities;
import com.angkorteam.pluggable.utilities.RegistryUtilities;
import com.angkorteam.pluggable.utilities.RoleUtilities;
import com.angkorteam.pluggable.utilities.SecurityUtilities;
import com.angkorteam.pluggable.utilities.TableUtilities;
import com.angkorteam.pluggable.wicket.RequestMappingInfo;
import com.angkorteam.pluggable.wicket.authroles.authentication.AuthenticatedWebApplication;
...
public abstract class AbstractWebApplication extends
    ...
    protected final void init() {
        ...
        for (Class<? extends Job> job : getJobs()) {
            com.angkorteam.pluggable.entity.Job meta = JobUtilities
    ...
    public Class<? extends AbstractUser> getUserEntity() {
        return com.angkorteam.pluggable.entity.User.class;
    }
