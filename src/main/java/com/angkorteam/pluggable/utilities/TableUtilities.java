...
import com.angkorteam.pluggable.database.DatabaseException;
...
public class TableUtilities {
    ...
    public static final String getTableName(Class<?> clazz) {
        ...
        com.angkorteam.pluggable.database.annotation.Table table = org.springframework.core.annotation.AnnotationUtils.findAnnotation(clazz, com.angkorteam.pluggable.database.annotation.Table.class);
