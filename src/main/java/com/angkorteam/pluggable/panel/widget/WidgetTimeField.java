...
import com.angkorteam.pluggable.validator.DateValidator;

/**
 * @author Socheat KHAUV
 */
public class WidgetTimeField extends Panel {
    ...
    public WidgetTimeField(String id, Map<String, Object> object, FieldController widget, Map<String, Object> components) {
        super(id);
