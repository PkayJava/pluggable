 ...
 */
@Mount("/eu")
@AuthorizeInstantiation(roles = { @com.angkorteam.pluggable.wicket.authroles.Role(name = "ROLE_PAGE_EDIT_USER", description = "Access Edit User Page") })
public final class EditUserPage extends KnownPage {
    ...
    @com.angkorteam.pluggable.widget.LabelField(label = "Login", order = 1)
