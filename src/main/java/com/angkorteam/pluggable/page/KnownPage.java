...
import com.angkorteam.pluggable.panel.widget.WidgetCheckBox;
import com.angkorteam.pluggable.panel.widget.WidgetCheckBoxMultipleChoice;
import com.angkorteam.pluggable.panel.widget.WidgetDateField;
import com.angkorteam.pluggable.panel.widget.WidgetDateTimeField;
import com.angkorteam.pluggable.panel.widget.WidgetDropDownChoice;
import com.angkorteam.pluggable.panel.widget.WidgetFileUploadField;
import com.angkorteam.pluggable.panel.widget.WidgetImageField;
import com.angkorteam.pluggable.panel.widget.WidgetLabelField;
import com.angkorteam.pluggable.panel.widget.WidgetListMultipleChoice;
import com.angkorteam.pluggable.panel.widget.WidgetMultiFileUploadField;
import com.angkorteam.pluggable.panel.widget.WidgetPasswordTextField;
import com.angkorteam.pluggable.panel.widget.WidgetRadioChoice;
import com.angkorteam.pluggable.panel.widget.WidgetSelect2Choice;
import com.angkorteam.pluggable.panel.widget.WidgetSelect2MultiChoice;
import com.angkorteam.pluggable.panel.widget.WidgetTextArea;
import com.angkorteam.pluggable.panel.widget.WidgetTextField;
import com.angkorteam.pluggable.panel.widget.WidgetTimeField;
import com.angkorteam.pluggable.utilities.SelectionUtilities;
import com.angkorteam.pluggable.utilities.TableUtilities;
import com.angkorteam.pluggable.validation.constraints.DecimalMax;
import com.angkorteam.pluggable.validation.constraints.DecimalMin;
import com.angkorteam.pluggable.validation.constraints.Digits;
import com.angkorteam.pluggable.validation.constraints.Future;
import com.angkorteam.pluggable.validation.constraints.Max;
import com.angkorteam.pluggable.validation.constraints.Min;
import com.angkorteam.pluggable.validation.constraints.NotNull;
import com.angkorteam.pluggable.validation.constraints.Past;
import com.angkorteam.pluggable.validation.constraints.Pattern;
import com.angkorteam.pluggable.validation.constraints.Size;
import com.angkorteam.pluggable.validation.constraints.Unique;
import com.angkorteam.pluggable.validation.controller.ButtonController;
import com.angkorteam.pluggable.validation.controller.ChoiceController;
...
import com.angkorteam.pluggable.validation.type.ChoiceType;
...
import com.angkorteam.pluggable.widget.CheckBoxMultipleChoice;
import com.angkorteam.pluggable.widget.DropDownChoice;
import com.angkorteam.pluggable.widget.FileUploadField;
import com.angkorteam.pluggable.widget.ImageField;
import com.angkorteam.pluggable.widget.LabelField;
import com.angkorteam.pluggable.widget.ListMultipleChoice;
import com.angkorteam.pluggable.widget.MultiFileUploadField;
import com.angkorteam.pluggable.widget.RadioChoice;
import com.angkorteam.pluggable.widget.Select2Choice;
import com.angkorteam.pluggable.widget.Select2MultiChoice;
...
public abstract class KnownPage extends WebPage {
    ...
    private void initializeInterceptor() {
        ...
        for (Method method : ReflectionUtils.getAllMethods(this.getClass())) {
            if (method
                    .getAnnotation(com.angkorteam.pluggable.widget.Button.class) != null) {
                com.angkorteam.pluggable.widget.Button widget = method
                        .getAnnotation(com.angkorteam.pluggable.widget.Button.class);
        ...
        ListView<ButtonController> commandListView = new ListView<ButtonController>(
            ...
            protected void populateItem(ListItem<ButtonController> item) {
                ...
                item.add(button);
                if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.DEFAULT) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-default"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.PRIMARY) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-primary"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.SUCCESS) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-success"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.INFO) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-info"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.WARNING) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-warning"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.DANGER) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-danger"));
                } else if (command.getButton().type() == com.angkorteam.pluggable.validation.type.ButtonType.LINK) {
                    button.add(AttributeModifier.replace("class",
                            "btn btn-link"));
                }
